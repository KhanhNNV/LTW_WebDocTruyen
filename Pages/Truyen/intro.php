...
<body>
    ...
    <div class="main-content">
        ...
        <div class="center-content">
            ...
            <div class="buttons">
                <button id="ds"><i class="fa-sharp-duotone fa-solid fa-list"></i><a href="#danhsach"> Danh sách truyện</a></button>
    ...
    <div class="chapter-list">
        <p size="14"><i class="fa-sharp-duotone fa-solid fa-list"></i><b><a name="danhsach">DANH SÁCH CHƯƠNG TRUYỆN</a></b></p>
